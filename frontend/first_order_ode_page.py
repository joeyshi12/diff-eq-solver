...
class FirstOrderODEPage(Page):
    ...
    entries: dict
    file_name: str = "first_order_ode.xlsx"
    ...
    def __init__(self, *args, **kwargs):
        ...
        tk.Button(self, text="Solve", font=self.font, width=10, command=self.solve).grid(row=5, column=2, pady=10,
                                                                                         sticky="w")
